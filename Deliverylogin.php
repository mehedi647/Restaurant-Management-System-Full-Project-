...
<head>
    <meta charset="utf-8">
    <title>Delivery Man Login Page</title>
...
<body>
    <div class="login-box">
        <h1>Delivery Man Login</h1><br>


        <form class="form-horizontal" method="POST" action="deliveryLogin_code.php" onsubmit="return validation();" >
            ...
            <button type="button" onclick="window.location.href='deliveryRagistration.php';">
                Sign Up
            </button>
