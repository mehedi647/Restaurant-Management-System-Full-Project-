...
<body>
    <div class="login-box">
        ...
        <form class="form-horizontal" method="POST" action="customerLogin_code.php" onsubmit="return validation();" >
            ...
            <button type="button" onclick="window.location.href='customerRagistration.php';">
                Sign Up
            </button>
