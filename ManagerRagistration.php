...
<head>
    <meta charset="utf-8">
    <title>Manager Ragistration Page</title>
...
<body>
    <div class="login-box">
        <h1>Manager Sign Up</h1><br>


        <form class="form-horizontal" action="ManagerRegistration_code.php" method="POST" onsubmit="return validation();">
			...
			<button type="button" onclick="window.location.href='managerLogin.php';">
                Back
            </button>
        </form>
    </div>
