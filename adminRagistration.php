...
<head>
    <meta charset="utf-8">
    <title>Admin Ragistration Page</title>
...
<body>
    <div class="login-box">
        ...
        <form class="form-horizontal" action="adminRegistration_code.php" method="POST" onsubmit="return validation();" >
			...
			<button type="button" onclick="window.location.href='adminLogin.php';">
                Back
            </button>
        </form>
    </div>
