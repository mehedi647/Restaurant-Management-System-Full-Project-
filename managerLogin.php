...
<body>
    <div class="login-box">
        ...
        <form class="form-horizontal" method="POST" action="ManagerLogin_code.php" onsubmit="return validation();" >
            ...
            <button type="button" onclick="window.location.href='managerRagistration.php';">
                Sign Up
            </button>
